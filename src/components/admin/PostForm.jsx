        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto flex-grow">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 outline-none transition-all resize-none"
