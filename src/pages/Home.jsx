      ...
      <section id="vision-mission" className="py-16 md:py-24 px-4 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group relative bg-gradient-to-br from-blue-600 to-blue-700 p-8 md:p-10 rounded-3xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <div className="group relative bg-gradient-to-br from-slate-700 to-slate-800 p-8 md:p-10 rounded-3xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="absolute top-6 right-6 w-20 h-20 bg-white/10 rounded-full blur-2xl"></div>
              <div className="relative z-10">
                <div className="bg-white/20 backdrop-blur-sm w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
                  <Target className="text-white" size={32} />
      ...
      <section id="facilities" className="py-16 md:py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="group relative overflow-hidden rounded-xl h-64 shadow-md">
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-6">
                  <h3 className="text-white text-xl font-bold">Modern Classrooms & Labs</h3>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="administrators" className="py-16 md:py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="text-center p-6 rounded-xl hover:bg-gray-50 transition-colors">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">School Street, Bangued, Abra, Philippines</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-white p-3 rounded-lg shadow-sm text-primary">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@holyspiritacademy.edu.ph</p>
                  </div>
                </div>
              </div>
            </div>
